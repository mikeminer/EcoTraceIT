  ...
  terms: {
    it: {
      ...
      sections: [
        ...
        {heading: "Piani e pagamenti", paragraphs: ["Free, Starter, Pro ed Enterprise sono gestiti tramite Shopify App Pricing. Prezzi, periodo, prova, cambi piano e costi a consumo sono mostrati e addebitati da Shopify prima dell’attivazione."]},
    ...
    en: {
      ...
      sections: [
        ...
        {heading: "Plans and payments", paragraphs: ["Free, Starter, Pro and Enterprise are managed through Shopify App Pricing. Prices, billing period, trials, plan changes and usage costs are displayed and charged by Shopify before activation."]},
