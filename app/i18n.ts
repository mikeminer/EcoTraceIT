const copy = {
  it: {
    ...
    freeDescription: "100 ordini/mese, calcolo base e badge.", proDescription: "Ordini illimitati, report avanzati, packaging e Carbon Neutral.",
  ...
  en: {
    ...
    freeDescription: "100 orders/month, base calculation and badge.", proDescription: "Unlimited orders, advanced reports, packaging and Carbon Neutral.",
